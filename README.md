...
| `notifications` | SMS (Africa's Talking) / WhatsApp (Meta Cloud API, incl. templates) / Telegram / Email |
| `telegram`      | Admin **bot with commands** (/status, /find, /suspend, /restore, /balance) via webhook |
